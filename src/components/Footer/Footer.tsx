    ...
    >
      ...
      >
        ...
        <Stack direction="row" spacing={6} ml="auto" mr={{ base: `auto`, md: 5 }}>
          <SocialIcons label="GitHub" href="https://github.com/eric-lu-VT">
            <FaGithub />
          </SocialIcons>
          <SocialIcons label="LinkedIn" href="https://www.linkedin.com/in/eric-j-lu/">
            <FaLinkedin />
          </SocialIcons>
          {/*
          <SocialIcons label="Instagram" href="https://www.instagram.com/">
            <FaInstagram />
          </SocialIcons>
          */}
        </Stack>
